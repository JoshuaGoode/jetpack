 ...
 */
function jetpack_safe_register_block_type( $slug, $args = array() ) {
 ...
 *
 * @deprecated 7.1.0 Use jetpack_safe_register_block_type() instead
 *
 * @param string $slug Slug of the block.
 * @param array  $args Arguments that are passed into register_block_type.
 *
...
function jetpack_register_block( $slug, $args = array() ) {
	_deprecated_function( __FUNCTION__, '7.1', 'jetpack_safe_register_block_type' );
...
class Jetpack_Gutenberg {
	...
	public static function register_block( $slug, $args ) {
		_deprecated_function( __METHOD__, '7.1', 'jetpack_safe_register_block_type' );

		jetpack_safe_register_block_type( 'jetpack/' . $slug, $args );
	}
	 ...
	 * Register a block
	 *
	 * @deprecated 7.0.0 Use jetpack_safe_register_block_type() instead
	 *
	 * @param string $slug Slug of the block.
	...
	public static function register( $slug, $args, $availability ) {
		_deprecated_function( __METHOD__, '7.0', 'jetpack_safe_register_block_type' );
	...
	public static function get_availability() {
		 ...
		 *
		 * In the function call you supply, use `jetpack_safe_register_block_type()` to set a block as available.
